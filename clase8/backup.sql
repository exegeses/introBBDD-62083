...
--
-- Host: 127.0.0.1    Database: introDB62083
-- ------------------------------------------------------
...
INSERT INTO `destinos` VALUES (1,'Londres (Heathrow)',5,9711.00,5,5,1),(2,'Amsterdam (Schiphol)',5,6240.00,5,4,1),(3,'Miami (Wilcox Field)',4,6517.00,5,5,1),(4,'Tokio (Narita)',7,8704.00,5,5,1),(5,'Kuala Lumpur (KLIA)',8,8570.00,5,5,1),(6,'Bangkok (Suvarnabhumi)',8,8469.00,5,5,1),(7,'París (Charles de Gaulle)',5,7713.00,5,5,1),(8,'Cancún (Cancún)',3,6494.00,5,5,1),(9,'Milán (Malpensa)',5,6756.00,5,5,1);
...
INSERT INTO `regiones` VALUES (1,'América del Sur'),(2,'América Central'),(3,'Caribe y México'),(4,'América del Norte'),(5,'Europa Occidental'),(6,'Europa del Este'),(7,'Asia'),(8,'Oceania');
...
-- Dump completed on 2023-03-13 10:27:26
